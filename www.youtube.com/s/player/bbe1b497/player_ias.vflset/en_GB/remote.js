(function(g) {
    ...
    var P7 = function(a) {
        ...
        d$ = function(a) {
            a.hD && (a.player.removeEventListener("presentingplayerstatechange",
                a.hD), a.hD = null)
        },
        Isb = function(a, b, c) {
            a.bf = c;
    ...
    g.k.UC = function() {
        if (Z9(this)) {
            ...
            var b = this.B;
            (a || b ? a && b && a.trackName == b.trackName && a.languageCode == b.languageCode && a.languageName == b.languageName && a.kind == b.kind : 1) || (this.B = a, Gsb(this, a));
    ...
    b$.prototype.xc = function(a) {
        if (3 === this.api.getPresentingPlayerType()) {
            ...
            a = g.BO(a, 128) ? g.XO("Error on $RECEIVER_NAME", b) : a.hd() || g.wP(a) ? g.XO("Playing on $RECEIVER_NAME", b) : g.XO("Connected to $RECEIVER_NAME", b);
